...
Right now it is very simple, as it only checks if next 2 or 1 letters can be represented as abbreviations of elements, and if so it saves it and goes on with the input. However it has some problems.
